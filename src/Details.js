      ...
      <div>
        ...
        <div className='flex-column dashboard-container'>
          <div className='flex details-container'>
            {this.state.loaded && book['image_url'] ? <img className='img-book-details' src={book['image_url']} onError={this.handleLoad.bind(this)}/> : <div className='detail-default default-img'></div>}
